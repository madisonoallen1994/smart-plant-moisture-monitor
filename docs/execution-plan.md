...
2. Add: “We are currently on Step X.Y. Produce only what is needed to complete it.”
3. Ask the AI for:
...
2. **Milestone 2:** BLE broadcasts readable in nRF Connect
3. **Milestone 3:** Pi receives and logs readings
4. **Milestone 4:** Backend stores readings
5. **Milestone 5:** App displays live moisture
6. **Milestone 6:** Push notification triggers correctly
7. **Milestone 7:** Probe sleeps/wakes on schedule
